...
cp docs/motor-shapes.png docs/motor-coils.md docs/design-tools.md docs/creators.md docs/creator-families.md docs/stack-load-antennas.md "$STAGE/plugins/docs/"
